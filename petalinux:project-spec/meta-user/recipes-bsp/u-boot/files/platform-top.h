...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"readmac=i2c dev 2; i2c read 50 FA.1 6 0xFFFFFC00\0" \
	...
	"bootmmc=setenv bootargs ${bootargs} root=/dev/mmcblk0p2 rw rootwait cma=320M && load mmc 0 ${kernel_load_address} zImage && load mmc 0 ${devicetree_load_address} system.dtb && bootz ${kernel_load_address} - ${devicetree_load_address}\0" \
	"bootmedia=mmc\0" \
